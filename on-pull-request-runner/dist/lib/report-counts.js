...
export function countRuleFindings(rule) {
...
export function totalsFromReport(report) {
    if (!report?.spec) {
...
export function totalsFromBatchReports(batchReports) {
    let findings = 0;
    let fixes = 0;
    let changes = 0;
...
//# sourceMappingURL=report-counts.js.map
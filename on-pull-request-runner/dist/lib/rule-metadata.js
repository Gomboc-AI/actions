...
function scoreRank(value, missingRank) {
...
export function compareRulesByImpactRisk(a, b) {
    ...
    const riskDelta = scoreRank(riskA, Number.MAX_SAFE_INTEGER) -
...
export function sortRulesByImpactRisk(rules) {
